...
print(df_materials.isnull().sum())

print(" Checking zero values after cleaning:")
print((df_materials[num_cols] == 0).sum())
...
# -----------------------------
# Freeze datasets (final version)
# -----------------------------
print(" Freezing datasets...")
df_materials.to_csv(os.path.join(data_folder, "materials_frozen.csv"), index=False)
df_products.to_csv(os.path.join(data_folder, "products_frozen.csv"), index=False)
df_scores.to_csv(os.path.join(data_folder, "material_product_scores_frozen.csv"), index=False)
print(" Datasets frozen successfully!")
